#
#  Be sure to run `pod spec lint Swiftent.podspec' to ensure this is a
...
Swiftent is here to standardize a way to put your content into your views or other containers
  ...
  s.license      = "GNUv3"
  # s.license      = { :type => "GN", :file => "FILE_LICENSE" }
  ...
  # Or just: s.author    = "Dmitry Fa[n]tastik"
  # s.authors            = { "Dmitry Fa[n]tastik" => "dmitry.fantastik@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Dmitry Fa[n]tastik"
  ...
  s.source_files  = "Swiftent/Swiftent/Source/*.swift"
